...
return (
    <div className="fixed top-0 left-0 w-full z-50 shadow-lg rounded-b-3xl h-24 bg-white">
      <nav className="p-4 shadow-lg rounded-b-3xl border-b-2 border-[#121325] h-full">
...
{/* Navigation Links */}
          <ul className="hidden lg:flex space-x-8 font-[Gluten] text-xl text-black font-bold ml-8">
...
rel="noopener noreferrer"
              className="w-14 h-14 flex items-center justify-center rounded-full bg-[#121325] text-white shadow-md hover:bg-orange-400 hover:text-[#121325] transition-all duration-300"
